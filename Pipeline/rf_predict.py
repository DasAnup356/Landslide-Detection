...
def predict(image_in:str, 
    ...
    for j in range(ny):
        for i in range(nx):
            ...
            # Ensure only numeric feature values are used
    ...
    #predict
    proba = clf.predict(X)
    #threshold for probability of vegetation = proba_thresh
...
def main():
    ...
    parser.add_argument('--remove_small', type=int, default=50)
