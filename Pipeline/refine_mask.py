...
def refine_mask(mask_path, image_path, mask_out, overlay_out):
    ...
    if mask is None:
        print(f"Error: Could not read mask file '{mask_path}'. Please check the file path and integrity.")
        return
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mask_out", type=str, default="refined_mask.png", help="Path to save refined mask")
    parser.add_argument("--overlay_out", type=str, default="overlay.png", help="Path to save overlay image")
    args = parser.parse_args()

    refine_mask(args.mask, args.image, args.mask_out, args.overlay_out)
